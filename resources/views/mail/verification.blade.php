...
<body>
    ...
    <div class="jumbotron">
        <h1 class="display-3">Verification</h1>
        <p class="lead">This is email with contain verification link</p>
        <hr class="my-2">
        <p>This email purpose that you sign up to {{ config('app.name') }}</p>
        <p class="lead">
            <a class="btn btn-primary btn-lg" href="Jumbo action link" role="button">Verify</a>
        </p>
    </div>
 </di>
</body>
